 ...
 * `lib/blindTypes/verticalSheer.ts` declares in its `attributeSchema`. Nothing
...
export default function VerticalSheerForm({ draft, catalogs, onChange, footer }: BlindFormProps) {
  return (
