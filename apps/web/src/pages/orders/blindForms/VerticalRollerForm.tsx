 ...
 * `lib/blindTypes/verticalRoller.ts` declares in its `attributeSchema`. Nothing
...
export default function VerticalRollerForm({ draft, catalogs, onChange, footer }: BlindFormProps) {
  return (
