 ...
 * `lib/blindTypes/verticalPanel.ts` declares in its `attributeSchema`. Nothing
...
export default function VerticalPanelForm({ draft, catalogs, onChange, footer }: BlindFormProps) {
  return (
