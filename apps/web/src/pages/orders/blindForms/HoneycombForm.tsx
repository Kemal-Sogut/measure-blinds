 ...
 * `lib/blindTypes/honeycomb.ts` declares in its `attributeSchema`. Nothing
...
export default function HoneycombForm({ draft, catalogs, onChange, footer }: BlindFormProps) {
  return (
