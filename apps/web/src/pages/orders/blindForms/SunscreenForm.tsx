 ...
 * `lib/blindTypes/sunscreen.ts` declares in its `attributeSchema`. Nothing
...
export default function SunscreenForm({ draft, catalogs, onChange, footer }: BlindFormProps) {
  return (
